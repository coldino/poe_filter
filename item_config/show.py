...
items = {
	...
	"04 84+ Stygian Vise": {"other": ["PlayAlertSound 2 50", "ItemLevel >= 84"], "base": "Stygian Vise", "type": "show high"},
	"04 84+ Opal Ring": {"other": ["PlayAlertSound 2 50", "ItemLevel >= 84"], "base": "Opal Ring", "type": "show high"},
	"05 Steel Ring": {"other": ["PlayAlertSound 2 25"], "base": "Steel Ring", "type": "show normal"},
	"05 Crystal Belt": {"base": "Crystal Belt", "type": "ignore"},
	"05 Stygian Vise": {"other": ["PlayAlertSound 2 25"], "base": "Stygian Vise", "type": "show normal"},
	"05 Opal Ring": {"other": ["PlayAlertSound 2 25"], "base": "Opal Ring", "type": "show normal"},
